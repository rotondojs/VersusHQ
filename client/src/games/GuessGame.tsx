...
/**
 * Renders the Number Guesser game view and move controls.
 */
export default function GuessGame({
  ...
  /**
   * Returns whether the player at a given index is tied for the best guess.
   */
  ...
  /**
   * Formats the display text for one player's guess state.
   */
