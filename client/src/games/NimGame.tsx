...
/**
 * Renders the Nim game view and turn controls.
 */
export default function NimGame({
  ...
  /**
   * Returns either the current user's self-reference or a player's display name.
   */
  ...
  /**
   * Returns the possessive form of the relevant player's label.
   */
