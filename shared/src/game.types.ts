/**
 * Shared game contracts used by the client, server, and socket layers.
 */
import { z } from "zod";
import { type SafeUserInfo } from "./user.types.ts";
import { zBattleshipOpponentType, type BattleshipView } from "./games/battleship.types.ts";
...
export const zCreateGameRequest = z.discriminatedUnion("type", [
  z.object({ type: z.literal("nim") }),
  z.object({ type: z.literal("guess") }),
  z.object({
    type: z.literal("battleship"),
    opponentType: zBattleshipOpponentType,
  }),
]);
