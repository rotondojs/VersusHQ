...
import { type TournamentInfo } from "./games/tournaments/tournament.types.ts";
...
export interface ClientToServerEvents {
  ...
  tournamentWatch: (payload: WithAuth<string>) => void;
  tournamentUnwatch: (payload: WithAuth<string>) => void;
}
...
export interface ServerToClientEvents {
  ...
  tournamentWatched: (payload: TournamentInfo) => void;
  tournamentUpdated: (payload: TournamentInfo) => void;
}
